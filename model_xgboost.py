...
if __name__ == "__main__":
    ...
    clf_model = XGBoostModel(task_type='classification', n_estimators=100, learning_rate=0.1, max_depth=6)
    ...
    reg_model = XGBoostModel(task_type='regression', n_estimators=100, learning_rate=0.1, max_depth=6)
