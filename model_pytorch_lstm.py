...
class PyTorchLSTM:
    def __init__(self, task_type='classification', input_size=10, hidden_size=50, num_layers=2, learning_rate=0.001):
        ...
        self.model = LSTMModel(input_size, hidden_size, num_layers, self.output_size, task_type).to(self.device)
...
if __name__ == "__main__":
    ...
    clf_model = PyTorchLSTM(task_type='classification', input_size=X_train.shape[1], hidden_size=50, num_layers=2, learning_rate=0.001)
    ...
    reg_model = PyTorchLSTM(task_type='regression', input_size=X_train.shape[1], hidden_size=50, num_layers=2, learning_rate=0.001)
