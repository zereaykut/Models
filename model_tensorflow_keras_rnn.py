...
class RNNModel:
    ...
    def _build_model(self):
        model = Sequential()
        model.add(SimpleRNN(self.units, input_shape=self.input_shape, activation='relu'))
...
if __name__ == "__main__":
    ...
    clf_model = RNNModel(task_type='classification', input_shape=(X_train.shape[1], 1), units=50)
    ...
    reg_model = RNNModel(task_type='regression', input_shape=(X_train.shape[1], 1), units=50)
